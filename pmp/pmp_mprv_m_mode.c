...
/* Test description:
   ...
   but not for the UART. However we will the M-Mode bits and also the MPRV bit
   which will apply the settings immediately. As we are still in M-mode access
   to the UART is still granted and hence no exceptions from the PMP occure
 */
int main()
{
    int i = 0;
