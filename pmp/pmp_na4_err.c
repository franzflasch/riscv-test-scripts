...
#if (__riscv_xlen == 64)
    #include "../generated_files/rv64/compiled_files/pmp_user_na4_access_err_rv64.c"
    #define USER_PROGRAM generated_files_rv64_compiled_files_pmp_user_na4_access_err_rv64_bin
    #define USER_PROGRAM_LEN generated_files_rv64_compiled_files_pmp_user_na4_access_err_rv64_bin_len
#else
    #include "../generated_files/rv32/compiled_files/pmp_user_na4_access_err_rv32.c"
    #define USER_PROGRAM generated_files_rv32_compiled_files_pmp_user_na4_access_err_rv32_bin
    #define USER_PROGRAM_LEN generated_files_rv32_compiled_files_pmp_user_na4_access_err_rv32_bin_len
#endif
